...
function relationshipState(trust: number) {
  // TODO(relationship-status-ui): Render the persisted relationship status
  // (dating/friend/ex) as a badge. Keep the current relationship UI unchanged
  // until the dedicated relationship-screen update.
        ...
        <main className="pixel-shell app-screen flex min-h-screen items-start justify-center p-4">
          ...
          <div className="pixel-panel create-panel p-6">
            {createStep === "intro" && <section className="create-step" data-testid="onboarding-intro">
              ...
              <div className="create-copy space-y-3 text-[15px] leading-7 text-[#2a2018]">
            ...
            {createStep === "age" && <section className="create-step">
              ...
              <input aria-label="당신의 나이는 몇 살인가요?" className="pixel-input w-full px-4 py-3 text-sm" inputMode="numeric" pattern="[0-9]*" step="1" type="number" value={charAge} onChange={(event) => setCharAge(event.target.value.replace(/\D/g, ""))} />
