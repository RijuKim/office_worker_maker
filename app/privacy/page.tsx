        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed">
          <div>
            ...
            <p className="mt-2 text-[#4a3f35]">
              ...
              시뮬레이션 진행을 위해 캐릭터 이름, 나이, 전공 등 사용자가 직접 입력한 정보를 저장합니다.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-[#4a3f35]">
              수집된 정보는 계정 관리, 시뮬레이션 진행 상태 저장, 기록 열람 서비스 제공을 위해서만 사용됩니다.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-[#4a3f35]">
              회원 탈퇴 시 모든 개인정보는 즉시 삭제됩니다. 진행 기록은 익명화된 형태로 통계 목적으로 보관될 수 있습니다.
            </p>
          </div>
